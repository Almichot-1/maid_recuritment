...
func main() {
	...
	apiRouter.Group(func(wsProtected chi.Router) {
		...
		wsProtected.With(appmiddleware.NewIPRateLimitMiddleware("selections-websocket", 20, time.Minute)).Get("/selections/updates", selectionUpdatesHandler.SelectionsWebSocket)
